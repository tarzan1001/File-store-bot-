...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                bj = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡️ 𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘𝗦 ⚡️', url=f"https://t.me/+dfgfbvhJIrFlOTQ0")] ] ))
        ...
        ok = await message.reply_text(
            ...
            disable_web_page_preview=True,   
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚠️ 𝖡𝗈𝗍 1️⃣", url=f"https://t.me/TomLcu_bot"),InlineKeyboardButton("⚠️ 𝖡𝗈𝗍 2️⃣", url=f"https://t.me/LuffyTGx_bot")]]))
        ...
        await message.reply_text(
            ...
            disable_web_page_preview=True,   
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("👥 𝖴𝗉𝖽𝖺𝗍𝖾 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 💭", url=f"https://t.me/+a9047dKDBjM5MDk9")]]))
        return
    ...
    f = await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡️ 𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘𝗦 ⚡️', url=f"https://t.me/+a9047dKDBjM5MDk9") ] ] ))
    ok = await message.reply_text(
        text=script.DELETE_TXT,
        disable_web_page_preview=True,   
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚠️ 𝖡𝗈𝗍 1️⃣", url=f"https://t.me/TomLcu_bot"),InlineKeyboardButton("⚠️ 𝖡𝗈𝗍 2️⃣", url=f"https://t.me/LuffyTGx_bot")]]))
