...
from database.ia_inlinedb import Media2, Media3, Media4, Media5, get_file_details, unpack_new_file_id
from utils import is_subscribed, get_size, temp
from info import CACHE_TIME, AUTH_CHANNEL, CUSTOM_FILE_CAPTION, REQ_CHANNEL, AUTH_USERS
...
def get_reply_markup(query):
    buttons = [[
                    ...
                    InlineKeyboardButton('🔍 𝖲𝖾𝖺𝗋𝖼𝗁 𝖧𝖾𝗋𝖾', switch_inline_query_current_chat=query)
                ]]
